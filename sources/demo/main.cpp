...
//#include <iostream>
//#include <cell/stb/stb_image.h>
//
//int main(int argc, char* argv[])
//{
//	int width, height, nrComponents;
//	//unsigned char* data = stbi_load("E:/projects/Cell-cmake/buildx2019/Release/textures/checkerboard.png", &width, &height, &nrComponents, 0);
//	unsigned char* data = stbi_load("textures/checkerboard.png", &width, &height, &nrComponents, 0);
//	if (nullptr == data) {
